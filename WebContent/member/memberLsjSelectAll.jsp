...
<html>
	<head>
		...
		<title>memberLsjSelectAll</title>
		...
		<script>
			$(function(){
				$("#updateBtn").click(function(){
					...
					$("#memberLsjSelectAll").attr("action","/mvc2Pattern/member").submit();
				});	
				...
				$("#mainBtn").click(function(){
					alert("mainBtn >>>>> ");
					$("#memberLsjSelectAll").attr("action","member/index.jsp").submit();
				});	
			});
		</script>
	</head>
	<body>
	<form name="memberLsjSelectAll" id="memberLsjSelectAll" method ="POST">
		<% 
			...
			%>
				...
				<tr>
					<td colspan="16" class="info_button">
						...
						<input type="button" value="메인" id="mainBtn" name="mainBtn" class="btn">
					</td>
				</tr>
				<!-- //tr -->
			</table>	
